...
Source0  : https://files.pythonhosted.org/packages/83/06/5834c6c40a2ecfcc3bcb954f6b0ec5bb20f0a7e58ad5ae1802f92a3a0ac6/jupyter_console-6.2.0.tar.gz
...
%prep
%setup -q -n jupyter_console-6.2.0
cd %{_builddir}/jupyter_console-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608011239
...
cp %{_builddir}/jupyter_console-6.2.0/COPYING.md %{buildroot}/usr/share/package-licenses/jupyter_console/4864371bd27fe802d84990e2a5ee0d60bb29e944
